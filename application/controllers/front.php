...
class Front extends CI_Controller {
	...
	function order_step2()
	{
					...
					else if($this->input->post('checkout_action')=='true')
					{
						...
						$this->form_validation->set_rules('address1', 'Alamat 1', 'trim|required');
						$this->form_validation->set_rules('address2', 'Alamat 2', 'trim|required');
						$this->form_validation->set_rules('city', 'Kota', 'trim|required');
						$this->form_validation->set_rules('county', 'Provinsi/Negara', 'trim|required');
