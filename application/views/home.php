				...
				<div id="right">
					<h1 class="bar">Katalog Rumah</h1>
						...
						foreach ($home_products as $product)
						{
							...
							<p><span>Rp. <?php echo number_format($product->item_price,2,',','.'); ?></span></p>
							<div class="actions">
								<!--<a href="<?php echo base_url();?>index.php/buy/<?php echo $product->item_id; ?>" class="add">-->
								<a href="<?php echo base_url();?>index.php/details/<?php echo $product->item_id; ?>/<?php echo strtolower(url_title($product->item_name)); ?>" class="add">Lihat Detail</a>
							</div>
						</div>
                        <?php $i++;}}else{ echo 'Maaf Belum ada Data';}?>
